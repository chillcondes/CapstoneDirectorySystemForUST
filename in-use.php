				...
				<div class="account-form-inner">
					<div class="">
						<div class="heading-bx left" align="center">
							<h2><span style="color: #be1630;"><?php echo $_SESSION['in-use']; ?></span> is already registered.<br><img src='assets/images/icon.png' style='width: 200px; height: 200px;'><br>Please contact administrator<br>for more information.
							<p>Log in your account <a href="index.php" style="color: #be1630;">Click here</a></p>
						</div>	
					</div>
				</div>
			</div>
