			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="ti-agenda"></i>Rejected Capstone Projects</li>
					</ul>
				</div>  
					...
					<div class="col-lg-12 m-b30">
						<div class="widget-box">
							<div class="wc-title">
								<div class="row">
									<div class="col-lg-6">
										<h4><img src="../assets/images/icon.png" style="width: 30px; height: 30px;">&nbsp;Rejected Capstone Projects</h4>
									</div>
									<div class="col-lg-6">
									</div>
								</div>
							...
							<div class="widget-inner">
								<div align="right">
									<a href="pending-projects" class="btn red radius-xl" style="float: right;background-color: #BE1630;"><i class="ti-harddrives"></i><span>&nbsp;PENDING CAPSTONE PROJECT (<?php echo $pending_proj; ?>)</span></a><br>
								</div>
