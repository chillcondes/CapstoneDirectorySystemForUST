										...
										<tbody>
											...
											<tr>
												<td>
													...
													<button type="button" class="btn red" style="width: 105px; height: 37px;" data-toggle="modal" data-target="#remove-<?php echo $project_id; ?>"><i class="ti-archive" style="font-size: 12px;"></i><span>&nbsp;Remove</span></button>
												</td>
											...
											<div id="remove-<?php echo $project_id; ?>" class="modal fade" role="dialog">
												<form class="edit-profile m-b30" method="POST">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/icon.png" style="width: 30px; height: 30px;">&nbsp;Remove to Best Capstone</h4>
															...
															<div class="modal-body">
																<div class="row">
																	<div class="form-group col-6">
																		...
																		<div>
																			<input type="hidden" name="capstone_id" value="<?php echo $project_id; ?>">
											...
											<?php
												...
												if (isset($_POST['remove'])) {
													...
													$model->editBestCapstone($award, $project_id);
