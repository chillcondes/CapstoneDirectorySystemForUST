	...
	<body class="ttr-opened-sidebar ttr-pinned-sidebar" oncopy="return false" oncut="return false" onpaste="return false">
		...
		<main class="ttr-wrapper" style="background-color: #F3F3F3;">
			<div class="container-fluid">
				...
				<h4 class="breadcrumb-title">Video Viewer</h4>
				<ul class="db-breadcrumb-list">
					<li><i class="fa fa-file"></i><?php echo strtoupper($type); ?></li>
				</ul>
			</div>	
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
						<div class="widget-box">
							<div class="wc-title">
								<h4><img src="../assets/images/icon.png" style="width: 30px; height: 30px;">&nbsp;<?php echo $title; ?> | <?php echo strtoupper($type); ?></h4>
							</div>
							<div class="widget-inner"> 
								<div class="wrapper">
									<video style="width: 100%;" controls>
										<source src="../directory/<?php echo $type; ?>/<?php echo $code; ?>.mp4" type="video/mp4">
