			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="fa fa-home"></i>Manage IP Registration Number</li>
					</ul>
				</div> 
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
						<div class="widget-box">
							<div class="wc-title">
								<h4><img src="../assets/images/icon.png" style="width: 30px; height: 30px;">&nbsp;Manage IP Registration Number</h4>
							</div>
									...
									<div class="col-lg-6">
										<div class="row">
											<div class="col-lg-6">
												...
												?>
												<p><?php echo $ip_code; ?>-0000</p>
											</div>
											<div class="col-lg-6">
												<button type="button" class="btn green" data-toggle="modal" data-target="#add-category" style="float: right;background-color: #BE1630;"><i class="ti-restore"></i><span>&nbsp;RESET & UPDATE IP REG. NUM.</span></button>
												<br><br><br>
											</div>
										</div>
									</div>
												...
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
														<div class="modal-header">
															<h4 class="modal-title"><img src="../assets/images/icon.png" style="width: 30px; height: 30px;">&nbsp;RESET & UPDATE IP REG. NUM.</h4>
														...
														<div class="modal-body">
															<div class="row">
																<div class="form-group col-12">
																	...
																	<div>
																		<input class="form-control" type="text" name="ip_code" min="3" max="100" value="<?php echo $ip_code; ?>" required>
																	</div>
																</div>
															</div>
														</div>
														<div class="modal-footer">
															<input type="submit" class="btn green radius-xl outline" name="update_ip" value="Submit">
										...
										<?php
											if (isset($_POST['update_ip'])) {
												$uip_code = $_POST['ip_code'];
												$model->updateIpCode($uip_code, $department_id);
												$model->resetIpCounter();
												echo "<script>window.open('manage-ip','_self');</script>";
											}
										?>
									<div class="col-lg-6">
