					...
					<div class="col-lg-12 m-b30">
						<div class="widget-box">
							...
							<div class="widget-inner"> 
								<div class="wrapper">
									<iframe style="height: 720px;" width="100%" height="100%" src="https://docs.google.com/gview?url=../directory/tasks.docx&embedded=true"></iframe>
<!-- 							  		<embed style="height: 720px;" width="100%" height="100%" src="../directory/tasks.docx" type=""> -->
