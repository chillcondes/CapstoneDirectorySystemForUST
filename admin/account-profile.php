<?php
	...
	if (!empty($account)) {
		foreach ($account as $acc) {
			...
			if ($status == 1) {
				$status = "<h5 style='color: green;'>ACTIVE ACCOUNT</h5>";
			}
			else {
				$status = "<h5 style='color: red;'>ARCHIVED ACCOUNT</h5>";
			}
			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="fa fa-home"></i>Account Profile</li>
					</ul>
				</div> 
				...
				<div class="row">
					<div class="col-lg-12 m-b30">
						<div class="widget-box">
							<div class="wc-title">
								<h4><img src="../assets/images/icon.png" style="width: 30px; height: 30px;">&nbsp;Account Profile</h4>
							</div>
							<div class="widget-inner">
								<div class="row">
									<div class="col-lg-6">
										<div class="new-user-list">
											<h3><?php echo ucwords(strtolower($fname)); ?> <?php echo ucwords(strtolower($lname)); ?><br><small style="font-size: 18px;"><?php echo $access;  ?>ACCOUNT</small></h3>
											<h5>University of Santo Tomas</h5>
											<h5><?php echo $dpt;  ?></h5>
												...
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
														<div class="modal-header">
															<h4 class="modal-title"><img src="../assets/images/icon.png" style="width: 30px; height: 30px;">&nbsp;Update Admin Profile</h4>
															<button type="button" class="close" data-dismiss="modal">&times;</button>
														</div>
														<div class="modal-body">
															<div class="form-group">
																<label class="col-form-label">Name</label>
																<input class="form-control" type="text" name="name" value="<?php echo $nm; ?>" pattern="[A-Za-z. ]+" onkeypress="return blockSpecialChar(event)" minlength="2" maxlength="60">
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																...
																<input class="form-control" type="text" value="<?php echo $unm; ?>" disabled>
															</div>
														</div>
														<div class="modal-footer">
															<input type="submit" class="btn green radius-xl outline" name="save" value="Update">
										...
										if (isset($_POST['save'])) {
											$fnm = $_POST['name'];
											$model->updateAdminName($fnm, $department_id);
										}
										?>
									</div>
									<div class="col-lg-6">
