					...
					<ul>
						...
						<li class="show">
							<a href="manage-faculty" class="ttr-material-button">
								<span class="ttr-icon"><i class="ti-agenda" style="color: #BE1630;"></i></span>
								<span class="ttr-label" style="color: #BE1630;">Manage Faculty</span>
							</a>
						</li>
						<li>
			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="ti-agenda"></i>Archived Faculty Accounts</li>
					</ul>
				</div>  
					...
					<div class="col-lg-12 m-b30">
						<div class="widget-box">
							<div class="wc-title">
								<div class="row">
									<div class="col-lg-6">
										<h4><img src="../assets/images/icon.png" style="width: 30px; height: 30px;">&nbsp;Archived Faculty Accounts</h4>
									</div>
									<div class="col-lg-6">
									</div>
								</div>
							...
							<div class="widget-inner">
								<div align="right">
									<a href="manage-faculty" class="btn red radius-xl" style="float: right;background-color: #BE1630;"><i class="ti-user"></i><span>&nbsp;ACTIVE FACULTY ACCOUNTS (<?php echo $faculty; ?>)</span></a><br>
								</div>
										...
										<tbody>
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/icon.png" style="width: 30px; height: 30px;">&nbsp;Restore Faculty Account</h4>
											...
											<?php
												...
												if (isset($_POST['restore'])) {
													...
													echo "<script>window.open('archived-faculty','_self');</script>";
												}
