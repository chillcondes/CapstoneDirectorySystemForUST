			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="ti-agenda"></i>Registered Capstone Projects</li>
					</ul>
				</div>  
					...
					<div class="col-lg-12 m-b30">
						<div class="widget-box">
							...
							<div class="widget-inner">
								<div align="right">
									<a href="add-project" class="btn green radius-xl" style="float: right;background-color: #BE1630;"><i class="ti-harddrives"></i><span>&nbsp;ADD CAPSTONE PROJECT</span></a><br>
								</div>
									...
									<table id="table" class="table table-bordered hover" style="width:100%">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo strtoupper($category); ?><span style="font-size: 1px;color: white;"><?php echo strtolower($keywords); ?></span></td>
												<td><?php echo $year; ?></td>
											</tr>
											<?php
												}
