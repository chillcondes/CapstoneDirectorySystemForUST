												...
												<table class="table table-bordered hover" style="width:100%">
													...
													<tr>
														...
														<?php if ($r_id == $s_id) { echo "<span style='font-size: 13px;'><b>LEADER</b></span>"; } 
															...
															if ($r_id == $account_id) { 
																echo '<a href="" data-toggle="modal" data-target="#remove-'.$s_id.'" class="btn red" style="width: 55px; height: 37px;"><i class="ti-trash" style="font-size: 16px;"></i></a>'; 
															}
															else {
																echo "N/A";
															}
															...
															<div class="modal-dialog modal-lg">
																<div class="modal-content">
																	...
																	<div class="modal-footer">
																		<button type="submit" name="remove_stud" class="btn red outline radius-xl">Remove</button>
													...
													<?php 
														...
														if (isset($_POST['remove_stud'])) {
															$collab_status = 3;
															$student_id = $_POST['user_id'];
															$model->updateCollabStatus($collab_status, $student_id, $department_id);
															echo "<script>alert('Student has been removed!');window.open('my-collaboration-details','_self');</script>";
														}
												...
												<table class="table table-bordered hover" style="width:100%">
													...
													<?php
														...
														if (isset($_POST['approve'])) {
															...
															$model->updateCollabStatus($collab_status, $student_id, $department_id);
															echo "<script>alert('Student has been approved!');window.open('my-collaboration-details','_self');</script>";
														}
														...
														if (isset($_POST['reject'])) {
															...
															$model->updateCollabStatus($collab_status, $student_id, $department_id);
															echo "<script>alert('Student has been rejected!');window.open('my-collaboration-details,'_self');</script>";
														}
