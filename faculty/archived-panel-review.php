			...
			<div class="container-fluid">
				<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="ti-view-grid"></i>Archived Panel Review</li>
					</ul>
				</div>  
					...
					<div class="col-lg-12 m-b30">
						<div class="widget-box">
							<div class="wc-title">
								<div class="row">
									<div class="col-lg-6">
										<h4><img src="../assets/images/icon.png" style="width: 30px; height: 30px;">&nbsp;Archived Panel Review</h4>
									</div>
									<div class="col-lg-6">
									</div>
								</div>
								...
								<div class="table-responsive">
									<table id="table" class="table table-bordered hover" style="width:100%">
										...
										<tbody>
											...
											<tr>
												<td>
													<a href="" class="btn green" style="width: 95px; height: 37px;"><i class="ti-back-right" style="font-size: 12px;"></i><span>&nbsp;Restore</span></a>&nbsp;
												</td>
